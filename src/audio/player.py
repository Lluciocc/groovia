...
class AudioPlayer(GObject.Object):
    ...
    def _new_pipeline(self, track, volume):
    ...
    def set_track(self, track, autoplay=True):
        ...
        self.pipeline = self._new_pipeline(track, self.volume)
        if self.pipeline:
    ...
    def _tick(self):
        ...
        try:
            ...
            if self.playing and duration > 0 and self.crossfade > 0 and duration - position <= self.crossfade:
